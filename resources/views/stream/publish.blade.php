...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="{{asset('ant-media')}}/css/external/bootstrap4/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('ant-media')}}/css/common.css" />
    <link rel="stylesheet" href="{{asset('ant-media')}}/css/samples.css" />
    <script src="{{asset('ant-media')}}/js/external/adapter-latest.js"></script>
</head>
...
<script src="{{asset('ant-media')}}/js/external/jquery-3.4.1.min.js" crossorigin="anonymous"></script>
<script src="{{asset('ant-media')}}/js/external/popper.min.js" crossorigin="anonymous"></script>
<script src="{{asset('ant-media')}}/js/external/bootstrap.min.js" crossorigin="anonymous"></script>
</body>
<script type="module" lang="javascript">
    import { WebRTCAdaptor } from "{{asset('ant-media')}}/js/webrtc_adaptor.js"
    import { getUrlParameter } from "{{asset('ant-media')}}/js/fetch.stream.js"
    import { SoundMeter } from "{{asset('ant-media')}}/js/soundmeter.js"
    import { generateRandomString, getWebSocketURL  } from "{{asset('ant-media')}}/js/utility.js"
